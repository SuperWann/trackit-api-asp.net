...
namespace backend_trackit.Context
{
    public class AdminContext
    {
        ...
        public List<OrderCustomerProcessed> getDataOrderOnProcessByKecamatan(int id_kecamatan_pengirim)
        {
            ...
            string query = @"select * from ""Order"" o 
                            ...
                            where id_kecamatan_pengirim = @id_kecamatan_pengirim";

            try
            {
                NpgsqlCommand cmd = db.GetNpgsqlCommand(query);
                cmd.Parameters.AddWithValue("@id_kecamatan_pengirim", id_kecamatan_pengirim);
        ...
        public bool createTrackingHistory(ProcessOrderAccepted data)
        {
            DBSQLhelper db = new DBSQLhelper(this._constr);
